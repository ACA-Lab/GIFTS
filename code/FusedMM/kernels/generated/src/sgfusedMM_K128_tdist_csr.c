...
#ifdef BETA0
void sgfusedMM_K128_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K128_tdist_b1_csr
#endif
(
 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         ...
         VTYPE Vd0, Vd1, Vd2, Vd3, Vd4, Vd5, Vd6, Vd7, Vt;
         VTYPE Vatt0, Vatt1, Vatt2, Vatt3, Vatt4, Vatt5, Vatt6, Vatt7;
         float attrc = 0;
