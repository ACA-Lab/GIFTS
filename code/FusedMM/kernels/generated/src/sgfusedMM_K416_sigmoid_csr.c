...
#ifdef BETA0 
void sgfusedMM_K416_sigmoid_b0_csr
#else /* BETA1 version */
void sgfusedMM_K416_sigmoid_b1_csr
#endif
(
...
)
{
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2, Va3, Vc3, Va4, Vc4, Va5, Vc5,
                     ...
                     Vc21, Va22, Vc22, Va23, Vc23, Va24, Vc24, Va25, Vc25;
      INDEXTYPE iindex = i * 416; 
