...
#ifdef BETA0
void sgfusedMM_K96_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K96_tdist_b1_csr
#endif
(
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2, Va3, Vc3, Va4, Vc4, Va5,
                     Vc5;
      INDEXTYPE iindex = i * 96; 
 ...
 */
      ...
      {
         VTYPE Vb0, Vb1, Vb2, Vb3, Vb4, Vb5;
         VTYPE Vd0, Vd1, Vd2, Vd3, Vd4, Vd5, Vt;
         VTYPE Vatt0, Vatt1, Vatt2, Vatt3, Vatt4, Vatt5;
         float attrc = 0;
         INDEXTYPE colidj = indx[j];
         INDEXTYPE jindex = colidj*96;
