...
#ifdef BETA0 
void sgfusedMM_K368_sigmoid_b0_csr
#else /* BETA1 version */
void sgfusedMM_K368_sigmoid_b1_csr
#endif
(
 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         ...
         VTYPE Vatt0, Vatt1, Vatt2, Vatt3, Vatt4, Vatt5, Vatt6, Vatt7, Vatt8,
               ...
               Vatt17, Vatt18, Vatt19, Vatt20, Vatt21, Vatt22;
         float attrc = 0;
         INDEXTYPE colidj = indx[j];
         INDEXTYPE jindex = colidj*368;
