...
#ifdef BETA0
void sgfusedMM_K48_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K48_tdist_b1_csr
#endif
(
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2;
      INDEXTYPE iindex = i * 48; 
 ...
 */
      ...
      {
         VTYPE Vb0, Vb1, Vb2;
         VTYPE Vd0, Vd1, Vd2, Vt;
         VTYPE Vatt0, Vatt1, Vatt2;
         float attrc = 0;
         INDEXTYPE colidj = indx[j];
         INDEXTYPE jindex = colidj*48;
