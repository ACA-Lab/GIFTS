...
#ifdef BETA0
void sgfusedMM_K304_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K304_tdist_b1_csr
#endif
(
 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         VTYPE Vb0, Vb1, Vb2, Vb3, Vb4, Vb5, Vb6, Vb7, Vb8, Vb9, Vb10, Vb11,
               Vb12, Vb13, Vb14, Vb15, Vb16, Vb17, Vb18;
         VTYPE Vd0, Vd1, Vd2, Vd3, Vd4, Vd5, Vd6, Vd7, Vd8, Vd9, Vd10, Vd11,
               Vd12, Vd13, Vd14, Vd15, Vd16, Vd17, Vd18, Vt;
