...
#ifdef BETA0
void sgfusedMM_K320_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K320_tdist_b1_csr
#endif
(
...
)
{
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2, Va3, Vc3, Va4, Vc4, Va5, Vc5,
                     ...
                     Vc16, Va17, Vc17, Va18, Vc18, Va19, Vc19;
      INDEXTYPE iindex = i * 320; 
