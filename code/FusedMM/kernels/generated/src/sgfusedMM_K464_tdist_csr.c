...
#ifdef BETA0
void sgfusedMM_K464_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K464_tdist_b1_csr
#endif
(
...
)
{
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2, Va3, Vc3, Va4, Vc4, Va5, Vc5,
                     ...
                     Vc26, Va27, Vc27, Va28, Vc28;
      INDEXTYPE iindex = i * 464; 
 ...
 */
      ...
      for (INDEXTYPE j = pntrb[i]; j < pntre[i]; j++)
      {
         ...
         VTYPE Vatt0, Vatt1, Vatt2, Vatt3, Vatt4, Vatt5, Vatt6, Vatt7, Vatt8,
               ...
               Vatt25, Vatt26, Vatt27, Vatt28;
         float attrc = 0;
         INDEXTYPE colidj = indx[j];
         INDEXTYPE jindex = colidj*464;
