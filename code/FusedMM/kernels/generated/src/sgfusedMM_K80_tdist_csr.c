...
#ifdef BETA0
void sgfusedMM_K80_tdist_b0_csr
#else /* BETA1 version */
void sgfusedMM_K80_tdist_b1_csr
#endif
(
...
#endif
   {
      register VTYPE Va0, Vc0, Va1, Vc1, Va2, Vc2, Va3, Vc3, Va4, Vc4;
      INDEXTYPE iindex = i * 80; 
 ...
 */
      ...
      {
         VTYPE Vb0, Vb1, Vb2, Vb3, Vb4;
         VTYPE Vd0, Vd1, Vd2, Vd3, Vd4, Vt;
         VTYPE Vatt0, Vatt1, Vatt2, Vatt3, Vatt4;
         float attrc = 0;
         INDEXTYPE colidj = indx[j];
         INDEXTYPE jindex = colidj*80;
